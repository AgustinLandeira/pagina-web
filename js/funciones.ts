...
const URL_BASE : string = "http://localhost/paginas/";//CAMBIE LA URL
...
// el parametro tipo puede ser: danger o succes,// lo muestra en el login ya sea o no correcto los valores
...
function Fail(retorno:any):void { // muestra un mensaje de error
